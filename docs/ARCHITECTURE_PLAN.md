...
- [x] Implement Dynamic Course Discovery (SerpAPI + Firecrawl + Gemini 2.5 Flash) and Milestone Overrides (see [COURSE_SEARCH_AND_MATCHING.md](file:///c:/Users/UwU/Desktop/skillsync/docs/COURSE_SEARCH_AND_MATCHING.md))

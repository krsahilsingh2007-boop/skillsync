# SkillSync AI Companion Service - Deployment Guide
...
services:
  ...
  watchtower:
    ...
    command: --interval 60 --include-restart skillsync-b3-ai-companion
    restart: unless-stopped
```
...
```bash
# Check logs
docker logs skillsync-b3-ai-companion

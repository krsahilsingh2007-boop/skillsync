...
- **Migrations**: Alembic
- **Dev URL**: `postgresql+asyncpg://postgres:postgres@localhost:5432/skillsync`
- **Prod URL**: `postgresql+asyncpg://postgres:postgres@db:5432/skillsync` (Docker service name)
...
```
DATABASE_URL=postgresql+asyncpg://USER:PASS@CLOUD_SQL_PUBLIC_IP:5432/skillsync
```

...
This document describes how search, personalized matching, real-time external course discovery, and milestone study-mode overrides are architected and operate within SkillSync.

---

## 1. High-Level Workflows

SkillSync merges standard local catalog search with dynamic real-time web scraping to supply students with highly aligned, up-to-date recommendations.

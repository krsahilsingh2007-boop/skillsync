        ...
        <Card className="max-w-md w-full border-2 border-violet-500/20 text-center p-6 space-y-6 bg-card/90 backdrop-blur">
          ...
          <CardHeader className="p-0">
            ...
            <CardDescription className="mt-2 text-sm">
              To chat with your AI Study Companion, please complete the onboarding questionnaire first. This allows SkillSync AI to customize advice to your learning styles and target career goals.
            </CardDescription>
          </CardHeader>
          <Button 
                ...
                <CardHeader className="p-4 border-b bg-gradient-to-r from-violet-50 to-purple-50 dark:from-violet-950/30 dark:to-purple-950/30">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <CardTitle className="text-lg font-bold text-violet-700 dark:text-violet-300">SkillSync AI</CardTitle>

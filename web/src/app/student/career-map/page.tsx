...
export default function CareerMap() {
  ...
  const handleEditDetails = (milestone: Milestone) => {
    ...
    setInfoDialogDesc("To edit course details or view details of this course, please visit the course catalog or contact SkillSync support.");
                    ...
                    <div className="border-t pt-4 mt-4">
                      ...
                      {selectedMilestone.type === "course" && (
                        <div className="mb-4 p-3 bg-amber-500/10 border border-amber-500/20 text-amber-700 dark:text-amber-400 rounded-lg text-xs flex items-start gap-2">
                          ...
                          <div>
                            To edit course details or view details of this course, please visit the course catalog or contact SkillSync support.
                          </div>
                        </div>
                      )}

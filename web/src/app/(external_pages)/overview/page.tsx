...
export default function Overview() {
  const sections = [
    {
      title: "Our Mission",
      description: "At SkillSync, we believe every learner deserves a clear, personalized path towards employable and future-ready skills. India’s skilling ecosystem offers countless opportunities, but many learners struggle to navigate their options. Our mission is to simplify this journey with the power of artificial intelligence.",
      icon: Target,
    ...
    {
      title: "What We Do",
      description: "SkillSync acts as a career navigator and skilling assistant. We empower learners to discover training programs tailored to their academic background, receive adaptive learning pathways that evolve dynamically, track real-time labor market trends, and build micro-credentials.",
      icon: Compass,
    ...
    },
    {
      ...
      description: "Skills are the ultimate foundation of modern employability, but upskilling shouldn't be a source of confusion. With SkillSync, learners gain instant clarity on milestone achievements, while trainers and policymakers secure real-time insights to prepare tomorrow's workforce.",
      icon: Award,

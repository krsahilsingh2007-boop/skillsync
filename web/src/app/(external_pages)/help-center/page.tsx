...
const faqCategories = [
  {
    ...
    questions: [
      { q: "What is SkillSync?", a: "SkillSync is an AI-powered career navigation platform that helps learners discover personalized skill pathways, track labor market trends, and build employable skills." },
      ...
      { q: "Is SkillSync really free?", a: "Yes! We offer a free tier with access to 50+ courses, basic progress tracking, and community forum access. Premium plans unlock additional features." },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      { q: "What browsers are supported?", a: "SkillSync works on all modern browsers including Chrome, Firefox, Safari, and Edge. We recommend keeping your browser updated." },
